<template>
  <div class="custom-order-detail">
    ...
    <mt-cell title="金额" >{{orderDetail.amount}}</mt-cell>
    ...
    <mt-cell title="授权到期日" >{{orderDetail.orderDate}}</mt-cell>
    <mt-cell title="交易单号" >{{orderDetail.orderNo}}</mt-cell>
    <mt-cell title="交易状态" >{{orderDetail.status}}</mt-cell>
